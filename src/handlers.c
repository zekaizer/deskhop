...
extern void rust_output_toggle(device_t *), rust_screen_border_hotkey(device_t *),
    rust_fw_upgrade_a(void), rust_fw_upgrade_b(void),
    rust_switch_lock_toggle(device_t *), rust_gaming_mode_toggle(device_t *),
    rust_screenlock_handler(device_t *), rust_wipe_config_hotkey(device_t *),
    rust_mouse_zoom_toggle(device_t *),
    rust_screensaver_pong_enable(device_t *), rust_screensaver_jitter_enable(device_t *),
    rust_screensaver_disable(device_t *), rust_config_enable(device_t *);

/* Hotkey handlers (referenced by hotkeys[] fn ptrs) — pass device_t* to Rust */
...
void switchlock_hotkey_handler(device_t *s, hid_keyboard_report_t *r) { rust_switch_lock_toggle(s); }
void toggle_gaming_mode_handler(device_t *s, hid_keyboard_report_t *r) { rust_gaming_mode_toggle(s); }
...
void mouse_zoom_hotkey_handler(device_t *s, hid_keyboard_report_t *r) { rust_mouse_zoom_toggle(s); }
void enable_screensaver_pong_hotkey_handler(device_t *s, hid_keyboard_report_t *r) { rust_screensaver_pong_enable(s); }
void enable_screensaver_jitter_hotkey_handler(device_t *s, hid_keyboard_report_t *r) { rust_screensaver_jitter_enable(s); }
void disable_screensaver_hotkey_handler(device_t *s, hid_keyboard_report_t *r) { rust_screensaver_disable(s); }
